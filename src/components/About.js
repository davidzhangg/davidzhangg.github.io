    ...
    return (
        <div className="about-area" id="about">
            ...
            <section className="resume-part">
                <a href="https://docs.google.com/document/d/1PqMuVdk_oqHz_Tj_Hj2Wio1mRVVyLhWa-SBX_TrtnnY/edit?usp=sharing" target="_blank" rel="noreferrer" className="resume-icon"><i class="far fa-file"></i></a>
