    ...
    return (
        <div className='banner-container' id="banner">
            ...
            <div data-aos="fade-up" className="banner-btns">
                <Button className="btns" buttonStyle='btn--outline' buttonSize='btn--large' path='https://docs.google.com/document/d/1PqMuVdk_oqHz_Tj_Hj2Wio1mRVVyLhWa-SBX_TrtnnY/edit?usp=sharing' newTab='_blank'>Check out my Resume!</Button>
            </div>
